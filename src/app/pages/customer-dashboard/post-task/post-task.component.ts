                            ...
                            <div>
                                ...
                                <div role="radiogroup" aria-labelledby="category-label" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                                    <button type="button" *ngFor="let category of SERVICE_CATEGORIES"
                                        ...
                                        class="p-4 rounded-2xl border-2 border-slate-200 hover:border-indigo-300 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 outline-none transition-all text-center group">
