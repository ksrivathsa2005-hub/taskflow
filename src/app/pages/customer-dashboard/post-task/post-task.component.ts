                ...
                <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                            ...
                            <div>
                                ...
                                <div role="radiogroup" aria-labelledby="category-label" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                                    <button *ngFor="let category of SERVICE_CATEGORIES"
                                        ...
                                        class="p-4 rounded-2xl border-2 border-slate-200 hover:border-indigo-300 cursor-pointer transition-all text-center focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 outline-none">
                        ...
                        <form class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input id="task-date" [(ngModel)]="formData.preferredDate" name="date" type="date"
                                        [min]="getTodayDate()"
                                        class="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none font-medium"
                                        required>
                                </div>
                    ...
                    <div *ngIf="currentStep === 3" class="p-8 md:p-12">
                        ...
                        <form class="space-y-6">
                            <!-- Budget -->
                            <div>
                                <label id="budget-label" class="block text-sm font-bold text-slate-700 mb-4">Budget Range (₹) *</label>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                            ...
                            <div>
                                ...
                                <div (click)="fileInput.click()" class="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-indigo-400 transition-colors cursor-pointer focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 outline-none">
