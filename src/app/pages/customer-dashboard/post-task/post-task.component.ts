                ...
                <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div *ngIf="currentStep === 3" class="p-8 md:p-12">
                        ...
                        <form class="space-y-6">
                            ...
                            <!-- Photos -->
                            <div>
                                <label id="photos-label" class="block text-sm font-bold text-slate-700 mb-3">Add Photos (Optional)</label>
                                <button type="button"
                                    aria-labelledby="photos-label"
                                    (click)="fileInput.click()"
                                    class="w-full border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-indigo-400 focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none transition-colors cursor-pointer">
