                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                                    <button *ngFor="let category of SERVICE_CATEGORIES"
                                        ...
                                        [attr.aria-pressed]="formData.category === category.id"
                                        ...
                                        class="p-4 rounded-2xl border-2 border-slate-200 hover:border-indigo-300 transition-all text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500">
                        ...
                        <form class="space-y-6">
                            ...
                            <div>
                                ...
                                <button type="button"
                                    ...
                                    class="w-full border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-indigo-400 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500">
                                ...
                                <div *ngIf="formData.photos.length > 0" class="mt-4 grid grid-cols-3 gap-3">
                                    <div *ngFor="let photo of formData.photos" class="relative group">
                                        <img [src]="photo" alt="Task photo preview" class="w-full h-24 object-cover rounded-lg border border-slate-200">
                                        <button (click)="removePhoto(photo)" type="button"
                                            aria-label="Remove photo"
                                            class="absolute top-1 right-1 bg-red-500 text-white p-1 rounded-full opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity">
