        ...
        <div class="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
          ...
          <div class="px-6 py-4 bg-slate-50 flex justify-end gap-3">
            <button 
              ...
              class="px-4 py-2 rounded-lg font-medium text-slate-700 hover:bg-slate-200 transition-colors focus-visible:ring-2 focus-visible:ring-slate-400 outline-none">
