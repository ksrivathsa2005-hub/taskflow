        ...
        <div *ngIf="showModal" class="fixed inset-0 z-[70] flex items-center justify-center px-4 bg-slate-900/60 backdrop-blur-sm"
            ...
            <div class="bg-white rounded-[2rem] w-full max-w-md overflow-hidden shadow-2xl">
                <div class="px-8 py-6 border-b border-slate-100 flex justify-between items-center">
                    ...
                    <button (click)="closeModal()" type="button" class="bg-slate-50 p-2 rounded-xl text-slate-400 hover:text-slate-600 focus:ring-2 focus:ring-indigo-500 outline-none"
                ...
                <form (ngSubmit)="submitReview()" class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2" role="group" aria-labelledby="rating-label">
                            <button *ngFor="let star of [1,2,3,4,5]" type="button" (click)="setRating(star)"
                                class="transition-all hover:scale-125 active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-lg"
