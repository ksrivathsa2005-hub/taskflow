        ...
        <div *ngIf="showModal"
            ...
            <div class="bg-white rounded-[2rem] w-full max-w-md overflow-hidden shadow-2xl">
                <div class="px-8 py-6 border-b border-slate-100 flex justify-between items-center">
                    ...
                    <button (click)="closeModal()" type="button" class="bg-slate-50 p-2 rounded-xl text-slate-400 hover:text-slate-600" aria-label="Close modal">
                ...
                <form (ngSubmit)="submitReview()" class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <p *ngIf="rating > 0 || hoveredRating > 0" class="text-xs text-indigo-600 mt-2 font-medium">
