...
@Component({
    ...
    template: `
        <div *ngIf="showModal" class="fixed inset-0 z-[70] flex items-center justify-center px-4 bg-slate-900/60 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="review-modal-title">
            <div class="bg-white rounded-[2rem] w-full max-w-md overflow-hidden shadow-2xl">
                <div class="px-8 py-6 border-b border-slate-100 flex justify-between items-center">
                    ...
                    <button (click)="closeModal()" type="button" class="bg-slate-50 p-2 rounded-xl text-slate-400 hover:text-slate-600 focus-visible:ring-2 focus-visible:ring-indigo-500 outline-none" aria-label="Close modal">
                        ...
                        <div class="flex gap-2" role="radiogroup" aria-labelledby="rating-label">
                            <button *ngFor="let star of [1,2,3,4,5]"
                                ...
                                <lucide-icon [img]="Star" 
                                    ...
                                    [class.text-slate-200]="star > (hoveredRating || rating)"
