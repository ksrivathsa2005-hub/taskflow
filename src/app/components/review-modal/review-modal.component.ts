            ...
            <div class="bg-white rounded-[2rem] w-full max-w-md overflow-hidden shadow-2xl">
                <div class="px-8 py-6 border-b border-slate-100 flex justify-between items-center">
                    ...
                    <button (click)="closeModal()" type="button"
                        class="bg-slate-50 p-2 rounded-xl text-slate-400 hover:text-slate-600 focus-visible:ring-2 focus-visible:ring-slate-300 outline-none"
                ...
                <form (ngSubmit)="submitReview()" class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2" role="radiogroup" aria-labelledby="rating-label">
                            <button *ngFor="let star of [1,2,3,4,5]; let i = index" type="button" (click)="setRating(star)"
                                class="transition-all hover:scale-125 active:scale-95 focus-visible:ring-2 focus-visible:ring-amber-300 rounded-lg outline-none"
                                [attr.aria-label]="star + ' star' + (star > 1 ? 's' : '')"
                                role="radio"
                                [attr.aria-checked]="rating === star"
                                [attr.aria-posinset]="star"
                                [attr.aria-setsize]="5">
                    ...
                    <div>
                        ...
                        <textarea id="review-comment" [(ngModel)]="comment" name="comment" rows="4" placeholder="Share your experience..."
                    ...
                    <button type="submit" [disabled]="isSubmitting"
                        class="w-full bg-indigo-600 text-white font-bold py-3 rounded-xl hover:bg-indigo-700 disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500 outline-none">
